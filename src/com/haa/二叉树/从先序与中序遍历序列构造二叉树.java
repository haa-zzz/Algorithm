...
public class 从先序与中序遍历序列构造二叉树 {
    ...
    public TreeNode buildTree(int[] preorder, int[] inorder) {
        ...
        return buildTreeHelper(preorder,0,preorder.length,inorder,0, map);
    }
    private TreeNode buildTreeHelper(int[] preorder, int p_start, int p_end, int[] inorder, int i_start,
